package com.example.securelock.mailservice;
...
public class EmailService extends AsyncTask<Void, Void, Void> {
    ...
    public EmailService(String senderEmail, String senderPass, String email, String subject, String message) {
    ...
    protected Void doInBackground(Void... voids) {
        Log.d("SendMail","In Email Background");
